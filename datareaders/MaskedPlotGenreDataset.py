...
class MaskedPlotGenreDataset(Dataset):
    def __init__(self, tokenizer: PreTrainedTokenizer, args, dir_path: str, block_size=512, is_train=False):
        ...
        cached_features_file = os.path.join(
            dir_path,modelstr + "_cached2_maskedgenplm4_" + str(block_size) + "_" + tokenizer_class
        )
...
if __name__ == '__main__':
    ...
    mds = MaskedPlotGenreDataset(tokenizer, args, path)
